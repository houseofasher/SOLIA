...
CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "phase": 1,
        "status": "partial",
        "frontier_gap": "1M context config; full backprop through all layers still in progress.",
    },
    {
        "id": "ciper_taxonomy",
    ...
    },
    {
        ...
        "phase": 2,
        "status": "planned",
        "frontier_gap": "Sub-second retrieval over full corpus — beats context stuffing for factual Q&A.",
    },
    {
        ...
        "phase": 2,
        "status": "planned",
        "frontier_gap": "862 micro classifiers in chat path — specialist beats generalist on domain tasks.",
    },
    {
        "id": "full_lm_backprop",
        ...
        "phase": 2,
        "status": "planned",
        "frontier_gap": "Train all layers from labeled corpus, not just embeddings + head.",
    },
    {
        "id": "rlhf_reward_loop",
        ...
        "phase": 3,
        "status": "planned",
        "frontier_gap": "Reward region scores replies; high-reward samples retrain weights automatically.",
    },
    {
        ...
        "phase": 3,
        "status": "planned",
        "frontier_gap": "Honest head-to-head on domain benchmarks — promote only when scores beat baseline.",
    },
    {
        ...
        "phase": 3,
        "status": "planned",
        "frontier_gap": "Every factual claim links to document_id + content_hash — auditable, not vibes.",
    },
    {
        ...
        "phase": 3,
        "status": "planned",
        "frontier_gap": "Say 'I don't know' when corpus + evaluators can't ground an answer.",
    },
    {
        "id": "agent_tool_loop",
        ...
        "phase": 4,
        "status": "research",
        "frontier_gap": "Multi-step plans with code execution, search, and verification gates.",
    },
    {
        ...
        "phase": 4,
        "status": "research",
        "frontier_gap": "Sparse attention + speculative decode — 1M context without O(n²) blowup.",
    },
    {
        "id": "multimodal",
        ...
        "phase": 5,
        "status": "research",
        "frontier_gap": "Vision/audio regions feeding the same supervised grade ladder.",
    },
)
